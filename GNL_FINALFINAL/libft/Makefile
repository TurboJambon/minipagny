...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/04 15:28:49 by dchirol           #+#    #+#              #
#    Updated: 2016/11/12 14:19:59 by dchirol          ###   ########.fr        #
#                                                                              #
#******************************************************************************#

NAME = libft.a

SRC = ft_power.c ft_factorial.c ft_swap.c ft_sqrt.c ft_isblanks.c ft_atoi.c ft_bzero.c \
